        ...
        <section className='statistics'>
            <h2 className='statistics__title'>Advanced Statistics</h2>
             ...
             <div className='statistics__card-container'>
               ...
               <StatisticCard src='/images/icon-brand-recognition.svg' title='Detailed Records' text='Gain insights into who is clicking your links. Knowing when and where people engage with your content helps inform better decisions.'/>
               <StatisticCard src='/images/icon-brand-recognition.svg' title='Fully Customizable' text='Improve brand awareness and content discoverability through customizable links, supercharging audience engagement.'/>        
             </div>
        </section>
    );
}
